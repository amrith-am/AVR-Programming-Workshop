...
#define LCD1_DATA B			//Port PC4-PC7 are connected to D4-D7
#define LCD1_DATA_POS 3		//PD3-PD6 are connected to lcd data pins

#define LCD1_E B 			//Enable/strobe signal
#define LCD1_E_POS	PB2		//Position of enable in above port

#define LCD1_RS B			//RS SIGNAL
#define LCD1_RS_POS PB0

#define LCD1_RW B			//RW SIGNAL
#define LCD1_RW_POS PB1
